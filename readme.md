...
![az datafactory show](./images/datafactory-show-identity.png)
...
![az databricks worskpace show](./images/databricks-workspace-show.png)

You can get the url for your Databricks notebook from the Control Plane UI:

![notebook url](./images/databricks-notebook-url.png)

### 4 - Connect Data Factory to your repo

You can do this in the Data Factory design surface, or via the Azure CLI.
